        ...
        public void Configure(EntityTypeBuilder<SubjectTeacher> entity)
        {
            ...
            entity.HasData
                (
                    ...
                    new SubjectTeacher { Id = new Guid("e3cb1bae-422b-459a-ae8d-37213e8577b7"), TeacherId = new Guid("a1a9f708-9a48-42fd-9308-3a106f9be31f"), SubjectId = new Guid("2e66193f-1903-49e9-a575-383024ede8d8"), IsMain = true },
                    ...
                    new SubjectTeacher { Id = new Guid("e9c90fa7-0d00-4e23-ae03-24a0182542dd"), TeacherId = new Guid("c85fbb73-6a36-4457-9477-0bb332b78d62"), SubjectId = new Guid("2e66193f-1903-49e9-a575-383024ede8d8"), IsMain = true },
                    ...
                    new SubjectTeacher { Id = new Guid("396e4be9-12b8-47fe-9737-3ab32686efbf"), TeacherId = new Guid("e7dc5f6e-0671-48ec-a298-9bd7ab8ffbf1"), SubjectId = new Guid("2e66193f-1903-49e9-a575-383024ede8d8"), IsMain = true },
                    ...
                    new SubjectTeacher { Id = new Guid("83e373d0-511b-43c2-932c-8aee95e4b5e9"), TeacherId = new Guid("f6a2d0e1-fcdc-4ea0-9c40-ffea09fd9490"), SubjectId = new Guid("2e66193f-1903-49e9-a575-383024ede8d8"), IsMain = true },
                    ...
                    new SubjectTeacher { Id = new Guid("281055b3-4736-4581-995c-e9d1f4d90833"), TeacherId = new Guid("4f2b309b-1b10-4204-b627-7d376533ea15"), SubjectId = new Guid("2e66193f-1903-49e9-a575-383024ede8d8"), IsMain = true },
                    ...
                    new SubjectTeacher { Id = new Guid("8dee3238-8b86-4e41-a8ac-dcbaaff34b54"), TeacherId = new Guid("b7adecee-f4d7-4a2d-8457-e5d27a427278"), SubjectId = new Guid("2e66193f-1903-49e9-a575-383024ede8d8"), IsMain = true },
                    new SubjectTeacher { Id = new Guid("99ccaba9-13fe-4ed8-bee9-742ee64e6e03"), TeacherId = new Guid("5fe80a00-fa41-476c-a915-0238a70672cc"), SubjectId = new Guid("2e66193f-1903-49e9-a575-383024ede8d8"), IsMain = true },
